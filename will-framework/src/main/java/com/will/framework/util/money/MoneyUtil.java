package com.will.framework.util.money;
...
public class MoneyUtil
{
  ...
  public static String getCHSNumber(Money m)
  {
    ...
    if (tmp_down != null)
    {
      ...
      {
        if (tmp[0] != '0') {
          chs = chs + "元" + CHS_NUMBER[((int)java.lang.Float.parseFloat(new java.lang.StringBuilder(String.valueOf(tmp[0])).append(".0").toString()))] + "角整";
        } else {
          chs = chs + "元整";
        }
      }
        ...
        chs = 
          chs + "元" + CHS_NUMBER[((int)java.lang.Float.parseFloat(new java.lang.StringBuilder(String.valueOf(tmp[0])).append(".0").toString()))] + "角" + CHS_NUMBER[((int)java.lang.Float.parseFloat(new java.lang.StringBuilder(String.valueOf(tmp[1])).append(".0").toString()))] + "分";
      } else if ((tmp[1] != '0') && (tmp[0] == '0')) {
        chs = chs + "元零" + CHS_NUMBER[((int)java.lang.Float.parseFloat(new java.lang.StringBuilder(String.valueOf(tmp[1])).append(".0").toString()))] + "分";
      }
    }
    else
    {
  ...
  {
    Money m = new Money();
    m.setCent(1670000005L);
    System.out.println(format(m));
    System.out.println(getCHSNumber(m));
    Money c = new Money(new BigDecimal("20.00400000000000001"));
